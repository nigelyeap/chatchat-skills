...
requires: []
examples:
  - "Help me decide whether to use regex or an LLM to parse this structured quiz text, and propose a hybrid pipeline"
  - "Design a confidence-scored regex-first extractor with an LLM fallback for edge cases"
---
