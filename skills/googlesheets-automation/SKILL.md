...
requires:
  - "mcp:rube"
examples:
  - "Update this Google Sheet: upsert rows by Email and then apply a filter for active users"
  - "Create a new Google Sheet, add a tab, and batch update a bounded range with these rows"
---
